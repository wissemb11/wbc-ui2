...
export const Changelog = defineComponent({
    ...
    setup(props) {
        ...
        const ChangelogHeader = () => h('div', { class: 'changelog-header', onClick: toggle }, [
        ...
        const ReleaseTag = ({ item, }) => h('li', { class: 'changelog release-tag' }, h('div', [
        ...
        const Commit = ({ item, }) => h('li', { class: 'changelog commit' }, [
