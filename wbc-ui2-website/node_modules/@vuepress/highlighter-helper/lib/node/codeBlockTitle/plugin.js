...
export const codeBlockTitle = (md, { codeBlockTitle: titleEnabledOrRender = true, } = {}) => {
    if (titleEnabledOrRender === false)
        return;
    const titleRender = titleEnabledOrRender === true ? defaultTitleRender : titleEnabledOrRender;
